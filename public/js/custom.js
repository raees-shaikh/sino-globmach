...
(function ($) {
    ...
    // > for products page magnificPopup function	by = magnific-popup.js =========================== //
    function magnific_popup_products() {
        jQuery('.mfp-gallery').magnificPopup({
            delegate: '.showImg',
            type: 'image',
            tLoading: 'Loading image #%curr%...',
    ...
    function magnific_popup_products_grid() {
        jQuery('.product-grid').magnificPopup({
            delegate: '.showImg',
            type: 'image',
            tLoading: 'Loading image #%curr%...',
            mainClass: 'mfp-img-mobile',
    ...
    function mobile_side_drawer() {
        jQuery('#mobile-side-drawer-sm').on('click', function () {
            jQuery('.mobile-sider-drawer-menu').toggleClass('active');
        });
    }
    ...
    jQuery(document).ready(function () {
        ...
        lightbox_popup(),
            ...
            // > magnificPopup function	by = magnific-popup.js
            magnific_popup(),
            magnific_popup_products(),
            magnific_popup_products_grid()
   ...
   ===========================*/
    ...
    jQuery(document).on('submit', 'form.backup-contact-form', function (e) {
        e.preventDefault();
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data['success']) {
                    jQuery("<div class='alert alert-success'>" + data['message'] + "</div>").insertBefore('form.backup-contact-form');
                } else {
                    jQuery("<div class='alert alert-danger'>" + data['message'] + "</div>").insertBefore('form.backup-contact-form');
                }
            }
        });
        jQuery('.backup-contact-form').trigger("reset");
        return false;
    });
