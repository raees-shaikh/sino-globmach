...
@section('content')
    ...
    <section id="banner-section" class="bg-prefix w-100"
        style='background-image:  url("{{ asset('frontend/mountain-images/mount-' . $category->id % 18 . '.jpg') }}") ;   background-attachment: fixed; background-repeat: no-repeat;background-size: cover; background-position:bottom'>
        <div class="overlay">
            <div class="container">
                                        ...
                                        <div class="card h-100">
                                            <div class="card-body pt-2 pb-0">
                                                <a
                                                    ...
                                                    <h6 class="card-title text-machine offer-title-style word-break">
                                                        {{ $offer->title }}
                                                    </h6>
                                                </a>
                                            </div>
