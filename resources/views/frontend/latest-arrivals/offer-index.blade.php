...
@section('pageTitle', ucfirst($subCatThree->name . ' - ' . $category->title . ' - Latest Proposals'))
@section('content')

    <!-- Banner Start -->
    <section id="banner-section" class="bg-prefix"
        style='background-image: url("{{ asset('frontend/mountain-images/mount-' . $subCatThree->id % 18 . '.jpg') }}") !important; background-attachment: fixed; background-repeat: no-repeat;background-size: cover; background-position:bottom'>
        <div class="overlay">
            <div class="container">
                <div class="row text-center mt-100-px pt-5">
                    <div class="col-md-12 mt-30">
                        <h1 class="lowercase text-white ">{{ $subCatThree->name }}</h1>
                    </div>
                    <div class="col-md-12 mt-2 divide">
                        <ul class="d-flex justify-content-center flex-wrap-links">
                            ...
                            <li><a href="#!" class="text-primary font-sm">{{ $subCatThree->name }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body pt-2 pb-0">
                                            <a
                                                ...
                                                <h6 class="card-title text-machine offer-title-style">{{ $offer->title }}
                                                </h6>
                                            </a>
                                        </div>
